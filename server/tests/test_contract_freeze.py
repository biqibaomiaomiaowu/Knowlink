...
def test_parse_contract_documents_quality_gate_and_vision_env_vars():
    ...
    for token in (
        ...
        "KNOWLINK_ENABLE_MINERU",
        "KNOWLINK_MINERU_TOKEN",
        "KNOWLINK_MINERU_MODEL_VERSION",
        "KNOWLINK_MINERU_IS_OCR",
        "KNOWLINK_MINERU_ENABLE_FORMULA",
        "KNOWLINK_MINERU_ENABLE_TABLE",
        "KNOWLINK_MINERU_MAX_RETRIES",
        "KNOWLINK_MINERU_DOWNLOAD_USE_PROXY",
        "mineru_failed",
