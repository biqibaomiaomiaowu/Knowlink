...
- V2 阶段二的知识图谱、流式输出和主观题判卷目前只有 `server/ai/v2/**` 的轻量 contract 类型入口；正式 API / read model / 输出 schema 仍需按 `docs/v2/phase-plan.md` 和 `docs/contracts/api-contract.md` 补齐后再实现。
