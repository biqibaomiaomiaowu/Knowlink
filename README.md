...
- [第 4 周比赛演示脚本与验收清单](./docs/week4-demo-runbook.md)
...
- 当前本地运行时已接通 PostgreSQL、Redis、MinIO、Dramatiq worker 和 scheduler；FastAPI 与 MinIO bucket CORS 默认允许本地 Flutter Web origin，生产环境可通过 `KNOWLINK_CORS_ALLOW_ORIGINS` 收紧。
