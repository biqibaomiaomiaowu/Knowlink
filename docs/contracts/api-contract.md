...
- V2 Phase 2 课程库、节课、工作台、分层资料和分层学习产物 contract 已单独冻结在 [v2-course-lesson-workbench-contract.md](./v2-course-lesson-workbench-contract.md)；课程列表、course workbench、LessonStudyPage frontend prototype parity、lesson handout real routes、lesson detail、resource scope、course QA、lesson QA、quiz / review / graph / export placeholder 和 home continue-learning 以该文档为准。
